...
const onAClick = async () => {
  const returnValue = await openModal('/single/modal-a')
...
const ModalAReturn = useModalReturnValue<any>('/single/modal-a')
const ModalAActive = useModalActive('/single/modal-a')
  ...
  >
    ...
    <div class="mt-3 grid gap-3">
      <div>
        <ElButton
          type="danger"
          @click="router.push('/single/modal-a')"
        >
